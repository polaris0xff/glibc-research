...
Fetched 2026-09-01T16:15:21Z by `scripts/common/mine-repo.sh`.

| | |
| --- | --- |
| commit | `90d5bcf6504396669441dac368b41a459e8ed1b5` |
| route | proxy |
...
## Trim applied after the fetch
  ...
  - `tree/CLAUDE.md` DELETED by this project, not absent
