...
| ⭐ **SDL** | **2 of 3 in, both passing** | ⭐ `dosbox` **11/11** clean **11/11** (**181** store paths compiled in, 169 resolving — the largest closure in the corpus) and `stella` **11/11** clean **11/11** (179/167). ⏳ `scummvm` |
...
| ⭐ **SDL** | ⏳ **2 of 3 in, and both work.** `dosbox` **11/11** clean **11/11** (181 store paths compiled in, 169 resolving — the largest closure measured here) and `stella` **11/11** clean **11/11** (179/167). ⛔ It was a *hypothesis* graded *Excellent* by the field until these rows; `scummvm` is still queued | §1; `65-` `sdl-1..3` |
