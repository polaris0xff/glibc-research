...
[`../HISTORY/entries/`](../HISTORY/entries/).
    ...
    RESULT    ⭐ SIX of the seven moved, five with numbers, and the corpus
              ...
              ⭐ FIVE capability categories CLOSED at three subjects each.
...
| the corpus | 1 of 26 rows | **21 of 26**, ⭐ **five categories CLOSED**, and five zeros run down to root cause |
...
| `65-` the corpus | ⏳ **21 of 26** | resumable; a recorded row is never re-measured, and a row from a broken instrument is DELETED |

## ⭐ FIVE CAPABILITY CATEGORIES ARE CLOSED
...
| **SDL** | `dosbox`, `stella`, `scummvm` | **11/11** each | **11/11** each |
...
## ⚠ What the next session inherits
    ...
    T-080  ⏳ 21 of 26. FINISH IT. RESUME.md has the PARALLEL recipe and
           the two-instance ceiling. Left: py-2, py-3, media-1 (after
           C39), field-1, field-2.
